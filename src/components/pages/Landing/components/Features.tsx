...
const items = [
  {
    ...
    description:
      "Visualize os principais indicadores e métricas essenciais do seu aprendizado.",
    imageLight: `url("${
  ...
  },
  {
    ...
    description:
      "Acesse seus cursos de QA diretamente do aplicativo mobile, onde estiver.",
    imageLight: `url("${
      process.env.TEMPLATE_IMAGE_URL || "https://mui.com"
  ...
  },
  {
    ...
    description:
      "Acesse nossos cursos pelo navegador, celular ou desktop, sem limitações.",
    imageLight: `url("${
      process.env.TEMPLATE_IMAGE_URL || "https://mui.com"
  ...
  return (
    <Container id="features" sx={{ py: { xs: 8, sm: 16 } }}>
      <Box sx={{ width: { sm: "100%", md: "60%" } }}>
        ...
        >
          Veja os principais recursos oferecidos pela plataforma CodeStation.
          Tudo que você precisa para se tornar um especialista em QA.
        </Typography>
      </Box>
      <Box
        sx={{
